...
const userSlice = createSlice({
  ...
  reducers: {
    ...
    resetCreatedColocation: (state) => {
      state.createdColocation = false;
    },
    ...
    handleSuccessfullParam: (state, action) => {
      console.log('HEY I LIKE POTATOES', action);
      return {
        ...state,
        settingUser: action.payload,
      };
    },
    ...
    resetError: (state) => {
      return {
        ...state,
        error: '', // Réinitialise le message d'erreur à une chaîne vide
      };
    },
